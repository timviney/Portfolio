...
function BulkUpdateForm({ state, run }) {
  ...
  if (accounts.length === 0) {
    return (
      <div className="bg-black/25 border border-gray-600 rounded-lg shadow-shadowOne p-8">
  ...
  return (
    <form
      onSubmit={handleSave}
      className="bg-black/25 border border-gray-600 rounded-lg shadow-shadowOne p-6 sml:p-8"
    >
